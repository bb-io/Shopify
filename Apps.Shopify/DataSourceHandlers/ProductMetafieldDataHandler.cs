...
public class ProductMetafieldDataHandler : ShopifyInvocable, IAsyncDataSourceHandler
{
    public ProductMetafieldDataHandler(InvocationContext invocationContext) : base(invocationContext)
    {
    }
