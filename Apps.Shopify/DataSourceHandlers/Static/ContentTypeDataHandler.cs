...
public class ContentTypeDataHandler : IStaticDataSourceItemHandler
{
    public IEnumerable<DataSourceItem> GetData()
    {
        ...
        [
            ...
            new DataSourceItem(TranslatableResource.METAFIELD.ToString(), TranslatableResource.METAFIELD.ToString().ToLower()),
            ...
            new DataSourceItem(TranslatableResource.PAGE.ToString(), TranslatableResource.PAGE.ToString().ToLower()),
